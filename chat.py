...
win = GraphWin("2D Array Output", 400, 300)
...
# def print_mp(mp,clock,text_lines):
...
def main():
    ...
    # text_lines = []
    # for i in range(row):
    #     t = Text(Point(400, 10 + i * 15), "")  # 每行垂直间距15像素
    ...
    pnt1 = graphics.Point( 0.1 * col , row/10 )
    rad1 = 10
